...
public class Login extends JFrame {
    ...
    void GUI()
    {
        ...
        JLabel lblRegister = new JLabel("Create an account ");
        lblRegister.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblRegister.setBounds(154, 283, 120, 14);
        contentPane.add(lblRegister);

        btnRegister = new JButton("Register Customer");
        btnRegister.setBounds(280, 280, 180, 23);
                ...
                else
                {
                    ...
                    else
                    {
                        if(username.equals("cashier"))
                        {
                            ...
                            if (DB.verifyLoginCustomer(username, password)) {

                                error.setText("");
                                customerPanel cP = new customerPanel(username);
                                cP.setVisible(true);
                                dispose();
                            } else
                                error.setText(errorText);
